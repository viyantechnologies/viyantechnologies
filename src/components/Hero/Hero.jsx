      ...
      <div className="max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10 py-4 lg:py-0 w-full">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-8 items-center">
          ...
          <motion.div
            ...
            className="text-left flex flex-col items-start space-y-6 w-full relative z-10"
          >
            ...
            <div className="flex flex-row sm:flex-wrap items-center gap-3 sm:gap-4 pt-4 w-full">
              <a
                href="#contact"
            ...
            <div className="flex flex-wrap items-center gap-10 md:gap-16 pt-6 w-full max-w-lg">
          ...
          <div className="absolute lg:relative inset-0 lg:inset-auto flex items-center justify-center pointer-events-none lg:pointer-events-auto opacity-35 sm:opacity-40 lg:opacity-100 z-0 lg:z-10 overflow-hidden lg:overflow-visible">
            <motion.div
